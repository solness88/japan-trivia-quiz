...
export async function generateQuizzes({
  ...
  // カテゴリー別の特別なガイドライン
  const categoryGuidelines: Record<QuizCategory, string> = {
    'anime-manga': `
ANIME / MANGA CATEGORY GUIDELINES:
- Focus on internationally popular anime/manga (Studio Ghibli, Naruto, One Piece, Dragon Ball, etc.)
- Connect anime/manga content to real Japanese culture (school life, festivals, food culture, language)
- Include cultural concepts frequently shown in anime (e.g., "What is a manga cafe?", "What does 'itadakimasu' mean?")
- Ask about anime tourism spots (Akihabara, anime pilgrimage sites, etc.)
- Balance entertainment value with educational cultural insights
- Avoid overly obscure references - stick to mainstream titles
`,
    culture: '',
    food: '',
    region: '',
